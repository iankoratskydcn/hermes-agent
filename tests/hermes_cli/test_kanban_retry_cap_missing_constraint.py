...
def fresh_home(tmp_path, monkeypatch):
    ...
    # F1's batch_approval_gate is default-gated and orthogonal to what these
    # Rule 4 tests exercise — bypass it the same way other dispatch-focused
    # suites do (test_kanban_per_profile_cap.py et al.) so a missing/pending
    # batch approval never masks the retry-cap assertions below.
